...
Protokół zamrożono przed uruchomieniem eksperymentów badawczych. Jego celem jest ochrona przed doborem testu, metryki lub progu po obejrzeniu wyniku. Wszystkie warianty korzystają z tych samych splitów, identycznej tokenizacji i przypiętego oficjalnego scorera. W rozdziale przedstawiono metryki, baseline’y, eksperymenty główne, ablacje, testy istotności oraz pomiar kosztu. Na końcu rozdzielono uruchomienia zredukowane od brakujących badań na pełnych danych.
